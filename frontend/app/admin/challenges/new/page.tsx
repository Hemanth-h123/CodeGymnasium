...
export default function NewChallengePage() {
  ...
  const [testCases, setTestCases] = useState<TestCase[]>([
    { id: '1', input: '', output: '', isHidden: false, score: 10 }
  ])
  ...
  useEffect(() => {
    const total = testCases.reduce((sum, tc) => sum + (tc.score || 0), 0)
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="md:col-span-2">
                ...
                <input
                  ...
                  placeholder="e.g., Algorithm Speed Challenge"
                />
              </div>
              ...
              <div className="md:col-span-2">
                ...
                <input
                  ...
                  placeholder="algorithm-speed-challenge"
                />
              </div>
          ...
          <div className="bg-white dark:bg-gray-800 rounded-lg shadow p-6">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    ...
                    <div>
                      ...
                      <input
                        ...
                        onChange={(e) => updateTestCase(testCase.id, 'score', parseInt(e.target.value) || 0)}
            ...
            <div className="mt-4 p-3 bg-blue-50 dark:bg-blue-900/20 rounded-lg">
              <p className="text-sm text-blue-800 dark:text-blue-200">
                <strong>Total Score:</strong> {formData.maxScore} points (from {testCases.length} test cases)
              </p>
            </div>
          </div>
          ...
          <div className="bg-white dark:bg-gray-800 rounded-lg shadow p-6">
            ...
            <div className="flex items-center">
              ...
              <label htmlFor="isPublished" className="ml-2 text-sm text-gray-700 dark:text-gray-300">
                Publish immediately (make challenge visible to participants)
              </label>
            </div>
          </div>
